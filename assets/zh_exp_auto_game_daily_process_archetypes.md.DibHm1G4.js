...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">uv</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> run</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> python</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> main.py</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> list</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">           # 列出流程文件</span></span></code></pre></div><p><strong>主要成就</strong>:</p><ul><li>从复杂的包结构简化为直接运行的脚本工具</li><li>解决了相对导入的问题</li><li>配置了国内镜像源，提高依赖安装速度</li><li>提供了完整的命令行界面</li><li>实现了完整的测试覆盖</li><li>修复了发现的序列化bug</li></ul>`,105),t=[p];function h(k,e,r,d,F,o){return a(),i("div",null,t)}const E=s(l,[["render",h]]);export{c as __pageData,E as default};
